...
class Product {
  ...
  html() {
    return `
    <table style="border: 1px solid #f0cc00; box-shadow: 0 0 5px #f0cc00; padding: 10px; width: 550px; font-family: HelveticaNeue-Light, Helvetica, Arial, sans-serif; font-size: 11pt; color: #555; background-color: #f5f5f5;">
      <tr style="vertical-align: top; text-align: left;">
        <td width="150">
          <a href="${this.url()}"><img style="width: 140px; border: 1px solid #888; box-shadow: 0 0 4px #444;" src="${this.image()}" width="140"></a>
        </td>
