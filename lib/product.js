...
class Product {
  ...
  html() {
    return `
    <table style="border: 1px solid #f0cc00; box-shadow: 0 0 5px #f0cc00; padding: 10px; width: 580px; font-family: HelveticaNeue-Light, Helvetica, Arial, sans-serif; font-size: 11pt; color: #555; background-color: #fafafa;">
