    ...
    <table style="border: 2px solid #f0cc00; padding: 10px; width: 600px; font-family: HelveticaNeue-Light, Helvetica, Arial, sans-serif; font-size: 11pt; color: #555; background-color: #f5f5f5;">
      <tr style="vertical-align: top; text-align: left;">
        ...
        <td style="padding-left: 10px; padding-right: 10px;">
          <div style="float:right; margin: 0 0 10 10; height: 90px; "><h1 style="margin: 0; padding: 0; font-family: HelveticaNeue-CondensedBold, Helvetica, Arial, sans-serif;">${this.priceFormatted()}</h1></div>
          <h2 style="color: #666;  font-family: HelveticaNeue-CondensedBold, Helvetica, Arial, sans-serif; font-size: 16pt;">${this.name()}</h2>
